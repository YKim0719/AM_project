...
if chr2>12 :
  ids1 = np.loadtxt("/pl/active/KellerLab/Yongkang/UKBhap/Meng/haps/indep_samp_hap/UKB_chr"+chr+".idx"+idx+".indep.haps",skiprows=0,dtype="str",usecols=(0,1,2,3,4,5),delimiter="\t")
  id = np.loadtxt("/pl/active/KellerLab/Yongkang/UKBhap/Meng/haps/indep_samp_hap/UKB_chr"+chr+".idx"+idx+".indep.haps",skiprows=0,dtype="bool_",delimiter="\t",converters = {0: str, 1: str, 2: str, 3: str, 4: str, 5: str, 6: str, 7: str, 8: str})
else :
  ...
  id = np.loadtxt("/pl/active/KellerLab/Yongkang/UKBhap/Meng/haps/indep_samp_hap/UKB_chr"+chr+".idx"+idx+".indep.haps",skiprows=1,dtype="bool_",delimiter=",",converters = {0: str, 1: str, 2: str, 3: str, 4: str, 5: str, 6: str, 7: str, 8: str})
...
iid = np.loadtxt("/pl/active/KellerLab/Yongkang/UKB_chr22.idx1.indep.vcf.recode.vcf",max_rows=1,skiprows=13,dtype="str",comments='!')
index=np.r_[0:9]
iid=np.delete(iid, index)
...
result_auto=np.matmul(pgs_score_auto2,hap_dat)
